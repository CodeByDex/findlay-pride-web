...
export function VolunteerComponent({ eventProps }: { eventProps: Event }) {
        ...
        <div className="shadow-box flex flex-col">
            ...
            <div className="flex flex-row flex-wrap">
                ...
                <div className=' md:w-3/5 w-full'>
                    {eventProps.volunteerURI && (
                        <div>
                            <strong>Volunteer Signup: </strong><Link href={eventProps.volunteerURI} target="_blank" className='underline'>{eventProps.volunteerURI}</Link>
                        </div>
                    )}
                    {eventProps.eventURI && (
