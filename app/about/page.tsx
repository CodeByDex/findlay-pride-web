...
import fcbLogo from "@public/partnerLogo/fcLogo.png"
        ...
        <main className="justify-items-center sm:max-w-5/6 md:max-w-3/4 gap-16  font-[family-name:var(--font-geist-sans)]">
            <div className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
                ...
                <div className="grid md:grid-cols-3 min-w-full gap-5">
                    ...
                    <div>
                        <div><Image src={fcbLogo} width={200} height={200} className='rounded-sm' alt="False Chord Logo" /></div>
                        <div>False Chord Brewing</div>
                        <div><Link href="https://www.falsechordbrewing.com/" target="_blank" className="underline">https://www.falsechordbrewing.com/</Link></div>
                        <div className="flex items-center gap-5">
                            <div className="">
                                <Link href="https://www.facebook.com/falsechordbrewing" target="_blank">
                                    <Image src={fbLogo} alt="facebook" width={30} height={30} className="rounded-full" />
                                </Link>
                            </div>
                        </div>
